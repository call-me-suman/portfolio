  ...
  return (
    <section className="relative flex flex-col items-center justify-between py-4 lg:py-12">
      ...
      <div className="grid grid-cols-1 items-start lg:grid-cols-2 lg:gap-12 gap-y-10">
        <div className="order-2 lg:order-1 flex flex-col items-start justify-center p-2 pb-40 md:pb-10 lg:pt-10">
          <h1 className="text-4xl font-bold leading-[3.5rem] text-white md:font-extrabold lg:text-[3.6rem] lg:leading-[4.5rem]">
            I am <br />
            <span
              className=" text-pink-500"
              onMouseOver={createMouseOverHandler(
                "SUMAN KESAVAN",
                intervalRef1
              )}
            >
            ...
            <span
              ...
              onMouseOver={createMouseOverHandler("STUDENT", intervalRef2)}
            >
              {" "}
              STUDENT
            </span>
          ...
          <div className="overflow-hidden border-t-[2px] border-indigo-900 px-4 lg:px-8 py-4 lg:py-8">
            <code className="font-mono text-xs md:text-sm lg:text-base">
              ...
              <div>
                ...
                <span className="text-gray-400">{`'`}</span>
                <span className="text-amber-300">Suman K</span>
                <span className="text-gray-400">{`',`}</span>
              </div>
              <div className="ml-4 lg:ml-8 mr-2">
                ...
                <span className="text-gray-400">{"', '"}</span>
                {/*  python mongodb , thirdweb  ,solidity ,  Machine Learning */}
                <span className="text-amber-300">Express</span>
                <span className="text-gray-400">{"', '"}</span>
                <span className="text-amber-300">ThirdWeb</span>
                <span className="text-gray-400">{"', '"}</span>
